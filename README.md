...
<p align="left">
ContactsApp for Socar
  </p>
  <p align="left">
To run the project, you can edit the connectionstring in appsetting.cs as you want. It will automatically create the sqlite file to the file path you have written.
</p>
